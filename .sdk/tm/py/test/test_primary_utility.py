...
from projectname_sdk import AdviceSlipApi2SDK
from projectname_sdk.core.spec import AdviceSlipApi2Spec
from projectname_sdk.core.result import AdviceSlipApi2Result
from projectname_sdk.core.response import AdviceSlipApi2Response
from projectname_sdk.core.operation import AdviceSlipApi2Operation
from projectname_sdk.core.error import AdviceSlipApi2Error
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import AdviceSlipApi2BaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return AdviceSlipApi2Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except AdviceSlipApi2Error as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = AdviceSlipApi2Result({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = AdviceSlipApi2SDK.test(None, None)
        ...
        class TestInitFeature(AdviceSlipApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(AdviceSlipApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = AdviceSlipApi2SDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = AdviceSlipApi2Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AdviceSlipApi2SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = AdviceSlipApi2Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AdviceSlipApi2SDK.test(None, setup_opts)
