...
class AdviceSlipApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AdviceSlipApi2TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AdviceSlipApi2TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AdviceSlipApi2TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
