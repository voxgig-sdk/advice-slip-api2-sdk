...
from projectname_sdk.core.control import AdviceSlipApi2Control
...
class AdviceSlipApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AdviceSlipApi2Control()
        ...
        if isinstance(sp, AdviceSlipApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AdviceSlipApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AdviceSlipApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AdviceSlipApi2Operation({})
    ...
    def make_error(self, code, msg):
        return AdviceSlipApi2Error(code, msg, self)
