...
// AdviceSlipApi2 SDK idempotency feature
...
class AdviceSlipApi2IdempotencyFeature extends AdviceSlipApi2BaseFeature
{
    ...
    private function _mutating(AdviceSlipApi2Context $ctx): bool
    {
