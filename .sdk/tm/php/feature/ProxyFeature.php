...
// AdviceSlipApi2 SDK proxy feature
...
class AdviceSlipApi2ProxyFeature extends AdviceSlipApi2BaseFeature
{
    ...
    public function init(AdviceSlipApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AdviceSlipApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
