...
// AdviceSlipApi2 SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AdviceSlipApi2MakeRequest
{
    public static function call(AdviceSlipApi2Context $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AdviceSlipApi2Response(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AdviceSlipApi2Response($fetched);
        } else {
