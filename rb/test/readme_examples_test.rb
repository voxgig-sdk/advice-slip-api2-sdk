...
#      offline in seeded test mode (AdviceSlipApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AdviceSlipApi2_sdk.rb")
  SDK_CLASS = "AdviceSlipApi2SDK"
