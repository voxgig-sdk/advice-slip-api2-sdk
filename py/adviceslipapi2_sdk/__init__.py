...
from adviceslipapi2_sdk.utility import register

# Load features
from adviceslipapi2_sdk.feature.base_feature import AdviceSlipApi2BaseFeature
from adviceslipapi2_sdk.features import _has_feature, _make_feature
...
class AdviceSlipApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AdviceSlipApi2Utility()
        self._utility = utility

        from adviceslipapi2_sdk.config import shared_config
    ...
    def get_utility(self):
        return AdviceSlipApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AdviceSlipApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Advice(self, data=None) -> "AdviceEntity":
        ...
        from adviceslipapi2_sdk.entity.advice_entity import AdviceEntity
        return AdviceEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from adviceslipapi2_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "AdviceSlipApi2SDK":
        if sdkopts is None:
            sdkopts = {}
