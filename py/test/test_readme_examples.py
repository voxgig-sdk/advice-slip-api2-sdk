# AdviceSlipApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AdviceSlipApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AdviceSlipApi2SDK(...) and AdviceSlipApi2SDK.test(...) become
#      AdviceSlipApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "adviceslipapi2_sdk"
_SDK_CLASS = "AdviceSlipApi2SDK"
