# AdviceSlipApi2 Python SDK



The Python SDK for the AdviceSlipApi2 API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/advice-slip-api2-sdk/releases)) or
...
```
py/
├── adviceslipapi2_sdk.py         -- Main SDK module
