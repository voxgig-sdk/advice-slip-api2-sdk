# AdviceSlipApi2 Python SDK Reference

Complete API reference for the AdviceSlipApi2 Python SDK.
...
#### `AdviceSlipApi2SDK.test(testopts=None, sdkopts=None)`
