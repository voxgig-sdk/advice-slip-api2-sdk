...
import (
	...
	vs "github.com/voxgig-sdk/advice-slip-api2-sdk/go/utility/struct"
)

type AdviceSlipApi2SDK struct {
	Mode     string
...
func (sdk *AdviceSlipApi2SDK) OptionsMap() map[string]any {
...
func (sdk *AdviceSlipApi2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AdviceSlipApi2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AdviceSlipApi2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AdviceSlipApi2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AdviceSlipApi2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AdviceSlipApi2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AdviceSlipApi2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AdviceSlipApi2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AdviceSlipApi2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AdviceSlipApi2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AdviceSlipApi2SDK {
	...
	sdk := NewAdviceSlipApi2SDK(sdkopts)
	sdk.Mode = "test"
