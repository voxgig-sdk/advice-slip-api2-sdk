...
func registerTools(server *mcp.Server, client *sdk.AdviceSlipApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "advice-slip-api2_list",
		Description: "List records from AdviceSlipApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "advice-slip-api2_load",
		Description: "Load a single record from AdviceSlipApi2. " +
...
func runOp(client *sdk.AdviceSlipApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AdviceSlipApi2SDK, name string) (sdk.AdviceSlipApi2Entity, error) {
