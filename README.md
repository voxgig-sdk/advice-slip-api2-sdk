...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/advice-slip-api2` | `npm install @voxgig-sdk/advice-slip-api2` |
| Python | `voxgig-sdk-advice-slip-api2` | `pip install voxgig-sdk-advice-slip-api2` |
| PHP | `voxgig-sdk/advice-slip-api2` | `composer require voxgig-sdk/advice-slip-api2` |
| Golang | `github.com/voxgig-sdk/advice-slip-api2-sdk/go` | `go get github.com/voxgig-sdk/advice-slip-api2-sdk/go` |
| Ruby | `voxgig-sdk-advice-slip-api2` | `gem install voxgig-sdk-advice-slip-api2` |
| Lua | `voxgig-sdk-advice-slip-api2` | `luarocks install voxgig-sdk-advice-slip-api2` |
