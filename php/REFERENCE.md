# AdviceSlipApi2 PHP SDK Reference

Complete API reference for the AdviceSlipApi2 PHP SDK.
...
```php
require_once __DIR__ . '/advice-slip-api2_sdk.php';
...
#### `AdviceSlipApi2SDK::test($testopts = null, $sdkopts = null)`
