...
// AdviceSlipApi2 SDK utility type

class AdviceSlipApi2Utility
{
    ...
    public static function copy(AdviceSlipApi2Utility $src): AdviceSlipApi2Utility
    {
        $u = new AdviceSlipApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
