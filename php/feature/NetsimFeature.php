...
// AdviceSlipApi2 SDK netsim feature
...
class AdviceSlipApi2NetsimFeature extends AdviceSlipApi2BaseFeature
{
    ...
    private function _simulate(AdviceSlipApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AdviceSlipApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
