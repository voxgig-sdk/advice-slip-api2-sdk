...
// AdviceSlipApi2 SDK rbac feature
...
class AdviceSlipApi2RbacFeature extends AdviceSlipApi2BaseFeature
{
    ...
    private function _required(AdviceSlipApi2Context $ctx): ?string
    {
    ...
    private function _reject(AdviceSlipApi2Context $ctx, string $required): void
    {
    ...
    private function _track(AdviceSlipApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
