...
// AdviceSlipApi2 SDK telemetry feature
...
class AdviceSlipApi2TelemetryFeature extends AdviceSlipApi2BaseFeature
{
    ...
    private function _close(AdviceSlipApi2Context $ctx, bool $ok): void
    {
