...
// AdviceSlipApi2 SDK metrics feature
...
class AdviceSlipApi2MetricsFeature extends AdviceSlipApi2BaseFeature
{
    ...
    private function _record(AdviceSlipApi2Context $ctx, bool $ok): void
    {
