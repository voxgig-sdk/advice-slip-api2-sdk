...
// AdviceSlipApi2 SDK timeout feature
...
class AdviceSlipApi2TimeoutFeature extends AdviceSlipApi2BaseFeature
{
    ...
    private function _with_timeout(AdviceSlipApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AdviceSlipApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
