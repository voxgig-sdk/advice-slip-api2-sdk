...
// AdviceSlipApi2 SDK ratelimit feature
...
class AdviceSlipApi2RatelimitFeature extends AdviceSlipApi2BaseFeature
{
    ...
    private function _acquire(AdviceSlipApi2Context $ctx): void
    {
    ...
    private function _track(AdviceSlipApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
