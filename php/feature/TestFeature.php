...
// AdviceSlipApi2 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AdviceSlipApi2TestFeature extends AdviceSlipApi2BaseFeature
{
    ...
    public function init(AdviceSlipApi2Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AdviceSlipApi2Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = AdviceSlipApi2Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AdviceSlipApi2Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AdviceSlipApi2Context $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = AdviceSlipApi2Param::call($ctx, $k);
