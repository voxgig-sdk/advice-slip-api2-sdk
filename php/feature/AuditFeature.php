...
// AdviceSlipApi2 SDK audit feature
...
class AdviceSlipApi2AuditFeature extends AdviceSlipApi2BaseFeature
{
    ...
    private function _emit(AdviceSlipApi2Context $ctx, string $outcome): void
    {
