...
// AdviceSlipApi2 SDK clienttrack feature
...
class AdviceSlipApi2ClienttrackFeature extends AdviceSlipApi2BaseFeature
{
    ...
    public function PostConstruct(AdviceSlipApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AdviceSlipApi2-SDK';
