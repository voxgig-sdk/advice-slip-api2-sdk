...
// AdviceSlipApi2 SDK cache feature
...
class AdviceSlipApi2CacheFeature extends AdviceSlipApi2BaseFeature
{
    ...
    private function _through(AdviceSlipApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
