...
// AdviceSlipApi2 SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AdviceSlipApi2Omni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AdviceSlipApi2Omni::structfix($now, Struct::undef()))
                        !== json_encode(AdviceSlipApi2Omni::structfix($val, Struct::undef()))) {
