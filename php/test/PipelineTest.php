...
// AdviceSlipApi2 SDK pipeline test
//
...
{
    private static function utility(): AdviceSlipApi2Utility
    {
        return new AdviceSlipApi2Utility();
    }
    ...
    private static function ctx(array $over = []): AdviceSlipApi2Context
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AdviceSlipApi2Context([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AdviceSlipApi2Operation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AdviceSlipApi2Error) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AdviceSlipApi2Operation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AdviceSlipApi2MakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AdviceSlipApi2Operation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AdviceSlipApi2MakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AdviceSlipApi2Operation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AdviceSlipApi2MakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AdviceSlipApi2Spec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AdviceSlipApi2MakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AdviceSlipApi2Response([]),
            'result' => new AdviceSlipApi2Result([]),
        ]);
        [, $err] = AdviceSlipApi2MakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AdviceSlipApi2Spec([]),
            'response' => null,
            'result' => new AdviceSlipApi2Result([]),
        ]);
        [, $err] = AdviceSlipApi2MakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AdviceSlipApi2Spec(['step' => 's']),
            'response' => new AdviceSlipApi2Response(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AdviceSlipApi2Result([]),
        ]);
        [, $err] = AdviceSlipApi2MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AdviceSlipApi2Spec(['step' => 's']),
            'response' => new AdviceSlipApi2Response(self::resp(200, ['v' => 1])),
            'result' => new AdviceSlipApi2Result([]),
        ]);
        [, $err] = AdviceSlipApi2MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AdviceSlipApi2Spec(['step' => 's']),
            'response' => new AdviceSlipApi2Response(self::resp(200, ['v' => 2])),
            'result' => new AdviceSlipApi2Result([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AdviceSlipApi2MakeResponse::call($ctx);
    ...
    {
        $preset = new AdviceSlipApi2Response(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AdviceSlipApi2Spec([]),
            'response' => new AdviceSlipApi2Response([]),
            'result' => new AdviceSlipApi2Result([]),
        ...
        [$got, $err] = AdviceSlipApi2MakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AdviceSlipApi2Result([])]);
        [, $err] = AdviceSlipApi2MakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AdviceSlipApi2Spec([]), 'result' => null]);
        [, $err] = AdviceSlipApi2MakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AdviceSlipApi2Spec(['step' => 's']),
            'result' => new AdviceSlipApi2Result(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AdviceSlipApi2Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AdviceSlipApi2MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AdviceSlipApi2Spec(['step' => 's']),
            'result' => new AdviceSlipApi2Result(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AdviceSlipApi2Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AdviceSlipApi2MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AdviceSlipApi2Result(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AdviceSlipApi2Spec([]),
            'result' => new AdviceSlipApi2Result([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AdviceSlipApi2MakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AdviceSlipApi2MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AdviceSlipApi2Error('boom', 'boom');
        $utility->fetcher = function (AdviceSlipApi2Context $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AdviceSlipApi2Spec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AdviceSlipApi2MakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AdviceSlipApi2Context $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AdviceSlipApi2MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AdviceSlipApi2Response::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AdviceSlipApi2MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AdviceSlipApi2Context $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AdviceSlipApi2Spec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AdviceSlipApi2MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AdviceSlipApi2Response(self::resp(201));
        $ctx = self::ctx(['spec' => new AdviceSlipApi2Spec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AdviceSlipApi2MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AdviceSlipApi2MakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AdviceSlipApi2MakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AdviceSlipApi2Result(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AdviceSlipApi2Done::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AdviceSlipApi2Result(['ok' => false])]);
        $this->expectException(AdviceSlipApi2Error::class);
        AdviceSlipApi2Done::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AdviceSlipApi2Result(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AdviceSlipApi2MakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AdviceSlipApi2MakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AdviceSlipApi2BaseFeature();
        $b = new AdviceSlipApi2BaseFeature();
        AdviceSlipApi2FeatureAdd::call($ctx, $a);
        AdviceSlipApi2FeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AdviceSlipApi2BaseFeature
    {
        $f = new AdviceSlipApi2BaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AdviceSlipApi2FeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AdviceSlipApi2Context
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AdviceSlipApi2Spec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AdviceSlipApi2PrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        AdviceSlipApi2PrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AdviceSlipApi2Response(['headers' => null]),
            'result' => new AdviceSlipApi2Result([]),
        ]);
        AdviceSlipApi2ResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AdviceSlipApi2ResultBody::call($ctx);
