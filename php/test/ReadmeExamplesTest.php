...
// AdviceSlipApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AdviceSlipApi2SDK::test)
...
{
    private const SDK_CLASS = 'AdviceSlipApi2SDK';
    ...
    private const SDK_BASE = 'adviceslipapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../adviceslipapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
