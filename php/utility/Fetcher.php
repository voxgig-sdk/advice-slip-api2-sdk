...
// AdviceSlipApi2 SDK utility: fetcher

class AdviceSlipApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AdviceSlipApi2SDK/1.0)';
    ...
    public static function call(AdviceSlipApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
