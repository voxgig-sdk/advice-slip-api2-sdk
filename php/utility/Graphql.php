...
// AdviceSlipApi2 SDK utility: graphql
//
...
class AdviceSlipApi2Graphql
{
    ...
    // equivalent.
    public static function body(AdviceSlipApi2Context $ctx): mixed
    {
    ...
    public static function errors(AdviceSlipApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
