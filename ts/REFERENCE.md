# AdviceSlipApi2 TypeScript SDK Reference

Complete API reference for the AdviceSlipApi2 TypeScript SDK.
...
```ts
new AdviceSlipApi2SDK(options?: object)
```
...
#### `AdviceSlipApi2SDK.test(testopts?, sdkopts?)`
...
**Returns:** `AdviceSlipApi2SDK` instance in test mode.
...
Alias for `AdviceSlipApi2SDK.test()`.
...
Return the parent `AdviceSlipApi2SDK` instance.
