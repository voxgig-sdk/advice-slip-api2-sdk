...
(0, node_test_1.describe)('SearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AdviceSlipApi2SDK({
...
function liveScenariosActive() { return false && process.env.ADVICE_SLIP_API2_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AdviceSlipApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ADVICE_SLIP_API2_TEST_SEARCH_ENTID'];
    ...
    const client = new __1.AdviceSlipApi2SDK({
        base: 'http://localhost:8080',
