# AdviceSlipApi2 Lua SDK



The Lua SDK for the AdviceSlipApi2 API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/advice-slip-api2-sdk/releases)),
...
```
lua/
├── advice-slip-api2_sdk.lua    -- Main SDK module
...
The main module (`advice-slip-api2_sdk`) exports the SDK constructor
