...
function runner.env_override(m)
  local live = runner.getenv("ADVICE_SLIP_API2_TEST_LIVE")
  local override = runner.getenv("ADVICE_SLIP_API2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ADVICE_SLIP_API2_TEST_EXPLAIN")
