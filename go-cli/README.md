...
AQL-driven CLI and REPL for the AdviceSlipApi2 SDK. Positional arguments are
...
```sh
go build -o advice-slip-api2-cli ./...
```
...
./advice-slip-api2-cli list advice
./advice-slip-api2-cli load 1 advice
./advice-slip-api2-cli load '{id:1}' advice
