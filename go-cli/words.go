...
func registerSDKWords(r *eng.Registry, client *sdk.AdviceSlipApi2SDK) {
...
func runOp(client *sdk.AdviceSlipApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
