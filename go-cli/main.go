// Command AdviceSlipApi2-cli is a CLI + REPL for the AdviceSlipApi2 SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ADVICE_SLIP_API2_APIKEY (api key), ADVICE_SLIP_API2_BASE (base url override)")
